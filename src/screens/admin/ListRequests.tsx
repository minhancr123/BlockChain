        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                {Array(4)
                    .fill(0)
                    .map((_, index) => (
                        <TouchableOpacity onPress={() => navigation.navigate("ConfirmCertification")} key={index} style={styles.card}>
            ...
            {/* Nút quay lại */}
            <TouchableOpacity style={{ margin: 5, flexDirection: "row", alignItems: 'center', justifyContent: "flex-end" }} onPress={() => { navigation.navigate("ListRequestsRejected") }}>
                <Text style={{ color: "black", fontWeight: "600", marginRight: 10 }}>Danh sách bằng cấp bị từ chối</Text>
                <Image
