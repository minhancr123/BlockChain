...
export const RegisterScreen = () => {
    return(
        <View style={styles.container} >
            ...
            <Input placeholder="Organization" icon={unitIcon}>
            </Input>
            

            <Input placeholder="Organization Unit" icon={ModuleIcon}>
            </Input>
            <Input placeholder="Common Name" icon={userIcon}>
            </Input>
            <Input placeholder="Email" icon={VectorIcon}>
            </Input>
